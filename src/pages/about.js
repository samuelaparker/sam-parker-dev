...
const About = () => {
    ...
    return (
        <Layout pageTitle="About Me">
            ...
            <Paragraph>You can find me on &nbsp;
                <a style={{textDecoration: 'none'}} href="https://www.linkedin.com/in/samuelaparker/" target="_blank" rel="noopener noreferrer"> Linkedin&nbsp; </a> and&nbsp;
                <a style={{textDecoration: 'none'}} href="https://github.com/samuelaparker" target="_blank" rel="noopener noreferrer">{' Github '}</a>
            </Paragraph>
